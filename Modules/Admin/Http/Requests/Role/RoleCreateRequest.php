...
class RoleCreateRequest extends RequestAbstract
{
    /**
    ...
    {
        return [
            'name'              => 'required|string|max:50|min:2|unique:roles,name',
            'identifier_name'   => 'required|string|max:50|min:2|unique:roles,identifier_name',
