<div class="card mt-3">
    <div class="card-header">
        <h3 class="card-title">Tìm kiếm Category</h3>
    </div>
    <div class="card-body">
        <form method="GET">
            <div class="row">
                ...
                <div class="form-group col-lg-3">
                    <input type="text" class="form-control" name="cat_name" placeholder="Name" value="{{ $_GET['cat_name'] ?? '' }}">
                </div>
                <div class="form-group col-lg-3">
                ...
                <div class="form-group col-lg-2">
                    <a href="{{ route('get.category.index') }}" class="btn btn-icon btn-secondary d-block">
