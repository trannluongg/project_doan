<div class="card card-warning" id="card-edit">
    ...
    <form>
        <div class="card-body">
            <input type="hidden" id="acc-user-id">
            ...
            <div class="form-group mt-4">
                <button type="button" class="btn btn-warning" id="edit-acc-user"><i class="fas fa-pencil-alt mr-2" aria-hidden="true"></i>Sửa</button>
            </div>
        </div>
    </form>
</div>
