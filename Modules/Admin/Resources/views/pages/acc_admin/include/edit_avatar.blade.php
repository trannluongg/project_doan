<div class="card card-info" id="card-edit-avatar">
    ...
    <form>
        <div class="card-body">
            <input type="hidden" id="acc-admin-id-avatar">
            ...
            <div class="form-group mt-4">
                <button type="button" class="btn btn-warning" id="edit-avatar-acc-admin"><i class="fas fa-pencil-alt mr-2" aria-hidden="true"></i>Sửa</button>
            </div>
        </div>
    </form>
</div>
