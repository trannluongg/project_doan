...
<body>
    <div class="content">
        <div class="title">
            <h1>HP SHOP.com - Website Bán Hàng Điện Tử</h1>
            <h2>Đơn Hàng</h2>
        </div>
        <div class="info">
            <h4>Khách hàng: Trần Văn Lương</h4>
            <span><strong>Số điện thoại: </strong>0987654321</span>
            <span><strong>Địa chỉ: </strong>Thái Bình</span>
            ...
            <h4 class="sum-money">Tống tiền: <span>400.000.000đ</span></h4>
        </div>
        <div class="shop">
            <span class="day">
