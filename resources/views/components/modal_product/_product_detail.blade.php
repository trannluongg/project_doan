    ...
    <div class="modal-body scroll">
        @switch($product['brand'])
            ...
            <ul class="parameterfull">﻿
                ...
                <li>
                    <span>Độ phân giải</span>
                    <div>{!! $camera_before[0]  ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                ...
                <li>
                    <span>ROM</span>
                    <div>{!! $file[0] ?? 'Đang cập nhật'  !!}</div>
                </li>
                <li>
                    <span>Hỗ trợ SD</span>
                    <div>{!! $file[1] ?? 'Đang cập nhật'  !!}</div>
                </li>
                <li>
                ...
                <li>
                    <span>Chất liệu</span>
                    <div>{!! $thietke[0] ?? 'Đang cập nhật'  !!}</div>
                </li>
                <li>
                    <span>Kích thước</span>
                    <div>{!! $thietke[1] ?? 'Đang cập nhật'  !!}</div>
                </li>
                <li>
                    <span>Trọng lượng</span>
                    <div>{!! $thietke[2] ?? 'Đang cập nhật'  !!}</div>
                </li>
                <li>
                    <label>Kết nối</label>
                </li>
                <li>
                    <span>Sim</span>
                    <div>{!! $connect[0] ?? 'Đang cập nhật'  !!}</div>
                </li>
                <li>
                    <span>Khe cắm sim</span>
                    <div>{!! $connect[1] ?? 'Đang cập nhật'  !!}</div>
                </li>
                <li>
                    <span>Wifi</span>
                    <div>{!! $connect[2] ?? 'Đang cập nhật'  !!}</div>
                </li>
                <li>
                    <span>Bluetooh</span>
                    <div>{!! $connect[3] ?? 'Đang cập nhật'  !!}</div>
                </li>
                <li>
                    <span>Cổng sạc</span>
                    <div>{!! $connect[4] ?? 'Đang cập nhật'  !!}</div>
                </li>
                <li>
                ...
                <li>
                    <span>Pin</span>
                    <div>{!! $thongtinthem[0] ?? 'Đang cập nhật'  !!}</div>
                </li>
                <li>
                    <span>Chế độ sạc nhanh</span>
                    <div>{!! $thongtinthem[1] ?? 'Đang cập nhật'  !!}</div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div>{!! $baohanh[0] ?? 'Đang cập nhật'  !!}</div>
                </li>
            </ul>
            @break
            @case(2)
            ...
            <ul class="parameterfull">﻿
                ...
                <li>
                    ...
                    <div>{!! $camera[0] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Camera trước</span>
                    <div>{!! $camera[1] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Đèn flash</span>
                    <div>{!! $camera[2] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Tính năng ngân hàng</span>
                    <div>{!! $camera[3] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <label>Kết nối</label>
                </li>
                ...
                <li>
                    ...
                    <div>{!! $connect[5] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div>{!! $thieke[0] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Kích thước</span>
                    <div>{!! $thieke[1] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>TRọng lượng</span>
                    <div>{!! $thieke[2] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                ...
                <li>
                    <span>Loại pin</span>
                    <div>{!! $pin[0] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Dung lượng</span>
                    <div>{!! $pin[1] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <label>Bảo hành</label>
                </li>
                ...
                <li>
                    <span>Xuất xứ</span>
                    <div>{!! $baohanh[1] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Năm SX</span>
                    <div>{!! $baohanh[2] ?? 'Đang cập nhật' !!}</div>
                </li>
            </ul>
            @break
            @case(3)
            ...
            <ul class="parameterfull">﻿
                ...
                <li>
                    <span>Hãng CP</span>
                    <div>{!! $dongsp[0] ?? 'Đang cập nhật'!!}</div>
                </li>
                <li>
                    <span>Công nghệ CPU</span>
                    <div>{!! $dongsp[1] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Loại CPU</span>
                    <div>{!! $dongsp[2] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Tốc độ CPU</span>
                    <div>{!! $dongsp[3] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Tốc độ tối đa</span>
                    <div>{!! $dongsp[4] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Bộ nhớ đệm</span>
                    <div>{!! $dongsp[5]  ?? 'Đang cập nhật'!!}</div>
                </li>
                <li>
                    <label>Bo mạch</label>
                </li>
                <li>
                    <span>Chíp</span>
                    <div>{!! $bomach[0]  ?? 'Đang cập nhật'!!}</div>
                </li>
                <li>
                    <span>Tốc độ Bus</span>
                    <div>{!! $bomach[1] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <label>Ram</label>
                </li>
                <li>
                    <span>Dung lượng</span>
                    <div>{!! $ram[0] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Loại Ram</span>
                    <div>{!! $ram[1]  ?? 'Đang cập nhật'!!}</div>
                </li>
                <li>
                    <span>Tốc độ bus Ram</span>
                    <div>{!! $ram[2] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Số lượng khe</span>
                    <div>{!! $ram[3] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <label>Đĩa</label>
                </li>
                <li>
                    <span>Loại đĩa</span>
                    <div>{!! $dia[0]  ?? 'Đang cập nhật'!!}</div>
                </li>
                <li>
                    <span>Dung lượng đĩa</span>
                    <div>{!! $dia[1]  ?? 'Đang cập nhật'!!}</div>
                </li>
                <li>
                    <label>Đồ họa</label>
                </li>
                <li>
                    <span>Chíp đồ họa</span>
                    <div>{!! $doahoa[0] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Bộ nhớ đồ họa</span>
                    <div>{!! $doahoa[1] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div>{!! $amthanh[0]  ?? 'Đang cập nhật'!!}</div>
                </li>
                <li>
                    <span>Cổng giao tiếp</span>
                    <div>{!! $amthanh[1] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Tính năng mở rộng</span>
                    <div>{!! $amthanh[2]  ?? 'Đang cập nhật'!!}</div>
                </li>
                <li>
                ...
                <li>
                    <span>LAN</span>
                    <div>{!! $giaotiepmang[0] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Chuẩn WIFI</span>
                    <div>{!! $giaotiepmang[1]  ?? 'Đang cập nhật'!!}</div>
                </li>
                <li>
                    <label>Webcam</label>
                </li>
                <li>
                    <span>Độ phân giải</span>
                    <div>{!! $webcam[0]  ?? 'Đang cập nhật'!!}</div>
                </li>
                <li>
                    <label>Pin</label>
                </li>
                ...
                <li>
                    <span>Kích thước</span>
                    <div>{!! $kichthuoc[0] ?? 'Đang cập nhật' !!}</div>
                </li>
                <li>
                    <span>Trọng lượng</span>
                    <div>{!! $kichthuoc[1]  ?? 'Đang cập nhật'!!}</div>
                </li>
                <li>
                    <span>Chất liệu</span>
                    <div>{!! $kichthuoc[2]  ?? 'Đang cập nhật'!!}</div>
                </li>
                <li>
                ...
                <li>
                    <span>Năm sx</span>
                    <div>{!! $thongtinthem[2]  ?? 'Đang cập nhật'!!}</div>
                </li>
            </ul>
            @break
            @case(4)
